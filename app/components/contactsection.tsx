            ...
            <Row className="my-3 py-5">
                <Col md={12} className="mb-3">
                    <Card className="text-center p-4">
                        <h2>Contact Us</h2>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Reiciendis minima eaque laudantium, quidem itaque maiores ratione odit impedit suscipit molestias saepe dolorem veritatis quo delectus quia totam, dicta quaerat ut.</p>
